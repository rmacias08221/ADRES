...
mapa <- ggplot(data = departamentos_shape1) +
  geom_sf(aes(fill = numero_prestadores), color = "white", size = 0.1) +
  scale_fill_gradient(low = "white", high = "blue", name = "Número de Prestadores") +
...
# Plotear el mapa
mapa <- ggplot(data = departamentos_shape1) +
  geom_sf(aes(fill = prestadores_por_1000_habitantes), color = "white", size = 0.1) +
  scale_fill_gradient(low = "white", high = "blue", name = "Número de Prestadores") +
...
mapa <- ggplot(data = departamentos_shape1) +
  geom_sf(aes(fill = prestadores_por_1000_habitantes), color = "white", size = 0.1) +
  scale_fill_gradient(low = "white", high = "blue", name = "Número de Prestadores por 1000 habitantes") +
  labs(title = "Cantidad de Prestadores cada 1000 habitantes por Departamento en Colombia",
       subtitle = "Intensidad del color indica la cantidad de prestadores cada 1000 habitantes",
       caption = "Fuente: Datos combinados de departamentos y prestadores") +
